<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <healthNotic-modal ref="modalForm" @ok="modalFormOk"></healthNotic-modal>
  </a-card>
</template>

<script>
  import HealthNoticModal from './modules/HealthNoticModal'
  import {
    JeecgListMixin
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: "/health/healthNotic/list",
          delete: "/health/healthNotic/delete",
          deleteBatch: "/health/healthNotic/deleteBatch",
          exportXlsUrl: "health/healthNotic/exportXls",
          importExcelUrl: "health/healthNotic/importExcel",
        },
      }
    },
    computed: {
