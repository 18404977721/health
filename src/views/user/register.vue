		...
		<div class="content-scroll">
			...
			<a-form :form="form" @submit="handleSubmit">
				<a-form-item label="姓  名" v-bind="formItemLayout">
					<a-input v-decorator="['note', { rules: [{ required: true, message: '请输入姓名' }] }]" />
				</a-form-item>
				...
				<a-form-item label="验证码" v-bind="formItemLayout">
					<a-input v-decorator="['note1', { rules: [{ required: true, message: '请输入验证码' }] }]" />
				</a-form-item>
				<a-form-item label="密码" v-bind="formItemLayout">
					<a-input v-decorator="['note2', { rules: [{ required: true, message: '请输入密码' }] }]" />
				</a-form-item>
				<a-form-item label="确认密码" v-bind="formItemLayout">
					<a-input v-decorator="['note3', { rules: [{ required: true, message: '请输入确认密码' }] }]" />
				</a-form-item>
				<a-form-item label="认证邀请" v-bind="formItemLayout">
					<a-input placeholder="请输入您的推荐人的注册手机号" v-decorator="['note3', { rules: [{ required: false, message: '请输入您的推荐人的注册手机号' }] }]" />
				</a-form-item>
