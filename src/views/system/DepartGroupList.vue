<template>
  <a-card :bordered="false" class="card-area">
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a-divider type="vertical"  v-has="'btn:edit'"/>
    ...
    <!-- 表单区域 -->
    <depart-group-modal ref="modalForm" @ok="modalFormOk"></depart-group-modal>
    <depart-group-detail-modal ref="modalDetail"></depart-group-detail-modal>
    <depart-group-show-modal ref="modalDetailShow"></depart-group-show-modal>
  </a-card>
</template>

<script>
  import DepartGroupModal from './modules/DepartGroupModal'
  import DepartGroupDetailModal from './modules/DepartGroupDetailModal'
  import DepartGroupShowModal from './modules/DepartGroupShowModal'
  import { JeecgListMixin } from '@/mixins/JeecgListMixin'

  export default {
    name: "DepartGroupList",
    mixins:[JeecgListMixin],
    components: {
      DepartGroupModal,
      DepartGroupDetailModal,
      DepartGroupShowModal
    },
    data () {
      return {

        description: '单位分组管理页面',
        // 查询条件
        ...
        url: {
          list: "/sys/departGroup/list",
          delete: "/sys/departGroup/delete",
          deleteBatch: "/sys/departGroup/deleteBatch",
          exportXlsUrl: "sys/departGroup/exportXls",
          importExcelUrl: "sys/departGroup/importExcel",
        },
      }
    },
    computed: {
    ...
    methods: {
      handlePerssion: function(groupId){
       // alert(roleId);
        this.$refs.modalDetail.show(groupId);
      },
