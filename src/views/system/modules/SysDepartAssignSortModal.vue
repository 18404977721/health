...
<script>
  import {queryDepartAssignGroupInfo} from '@/api/api'
  ...
  export default {
    ...
    methods: {
      show(departId){
        ...
        this.visible = true;
        queryDepartAssignGroupInfo({departId:that.departId}).then((res)=>{
      ...
      save(item){
        ...
        if(sortNo==''){
          ...
          var url = "/sysdepart/sysDepart/updateDepartAssignGroupSort?assignId="+id+'&sortNo='+sortNo;
