...
<script>
  import {editAssignGroups,queryDepartAssignGroup,queryallDepartGroup } from '@/api/api'
  export default {
    name: "SysDepartAssignModal",
    components: {
    ...
    methods: {
      ...
      loadUserGroups(departId){
        queryDepartAssignGroup({departId:departId}).then((res)=>{
          if(res.success){
