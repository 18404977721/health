...
<script>
  import {queryDepartCooperationGroupInfo} from '@/api/api'
  ...
  export default {
    ...
    methods: {
      show(departId){
        ...
        this.visible = true;
        queryDepartCooperationGroupInfo({departId:that.departId}).then((res)=>{
      ...
      save(item){
        ...
        if(sortNo==''){
          ...
          var url = "/sysdepart/sysDepart/updateDepartCooperationGroupSort?cooperationId="+id+'&sortNo='+sortNo;
