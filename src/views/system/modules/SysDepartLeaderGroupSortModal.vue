...
<script>
  import {queryDepartLeaderCommentGroupInfo} from '@/api/api'
  ...
  export default {
    ...
    methods: {
      show(departId){
        ...
        this.visible = true;
        queryDepartLeaderCommentGroupInfo({departId:that.departId}).then((res)=>{
      ...
      save(item){
        ...
        if(sortNo==''){
          ...
          var url = "/sysdepart/sysDepart/updateDepartLeaderCommentGroupSort?indexId="+id+'&sortNo='+sortNo;
