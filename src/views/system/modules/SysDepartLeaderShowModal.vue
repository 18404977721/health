...
<script>
  import {editLeaderShowGroups,queryDepartLeaderShowGroup,queryallLeaderGroup } from '@/api/api'
  export default {
    ...
    methods: {
      ...
      loadUserGroups(departId){
        queryDepartLeaderShowGroup({departId:departId}).then((res)=>{
          if(res.success){
      ...
      handleSubmit () {
        ...
        this.form.validateFields((err, values) => {
          if (!err) {
            ...
            let obj;
            obj=editLeaderShowGroups(formData);
