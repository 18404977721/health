...
<script>
  import {editIndexGroups,queryDepartIndexGroup,queryallDepartGroup } from '@/api/api'
  export default {
    ...
    methods: {
      ...
      loadUserGroups(departId){
        queryDepartIndexGroup({departId:departId}).then((res)=>{
          if(res.success){
