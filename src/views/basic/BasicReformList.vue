<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <basic-reform-modal ref="modalForm" @ok="modalFormOk"></basic-reform-modal>
  </a-card>
</template>
...
<script>
  ...
  import BasicReformModal from './modules/BasicReformModal'
  export default {
    name: "BasicReformList",
    ...
    data () {
      return {
        ...
        url: {
            list: "/common/reform/list",
            delete: "/common/reform/delete",
            deleteBatch: "/common/reform/deleteBatch",
            exportXlsUrl: "common/reform/exportXls",
            importExcelUrl: "common/reform/importExcel",
        },
        options: [],
        filter:true
      }
