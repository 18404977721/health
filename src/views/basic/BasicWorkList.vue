<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <basic-work-modal ref="modalForm" @ok="modalFormOk"></basic-work-modal>
  </a-card>
</template>
...
<script>
  ...
  import BasicWorkModal from './modules/BasicWorkModal'
  export default {
    name: "BasicWorkList",
    ...
    data () {
      return {
        ...
        url: {
            list: "/common/work/list",
            delete: "/common/work/delete",
            deleteBatch: "/common/work/deleteBatch",
            exportXlsUrl: "common/work/exportXls",
            importExcelUrl: "common/work/importExcel",
        },
        options: [],
        filter:true
      }
