<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <basic-recti-super-modal ref="modalForm" @ok="modalFormOk"></basic-recti-super-modal>
  </a-card>
</template>

<script>
  import BasicRectiSuperModal from './modules/BasicRectiSuperModal'
  import { JeecgListMixin } from '@/mixins/JeecgListMixin'
  import { getUsercenterAction } from '@/api/manage';
  export default {
    name: "BasicRectiSuperList",
    mixins:[JeecgListMixin],
    components: {
      BasicRectiSuperModal,
    },
    data () {
      return {
        // 表头
        ...
        url: {
            list: "/common/super/list",
            delete: "/common/super/delete",
            deleteBatch: "/common/super/deleteBatch",
            exportXlsUrl: "common/super/exportXls",
            importExcelUrl: "common/super/importExcel",
        },
        options: [],
        filter:true
      }
