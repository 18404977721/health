<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <basic-recti-audit-modal ref="modalForm" @ok="modalFormOk"></basic-recti-audit-modal>
  </a-card>
</template>

<script>
  import BasicRectiAuditModal from './modules/BasicRectiAuditModal'
  import { JeecgListMixin } from '@/mixins/JeecgListMixin'
  import { getUsercenterAction } from '@/api/manage';
  export default {
    name: "BasicRectiAuditList",
    mixins:[JeecgListMixin],
    components: {
      BasicRectiAuditModal,
    },
    data () {
      return {
        // 表头
        ...
        url: {
            list: "/common/audit/list",
            delete: "/common/audit/delete",
            deleteBatch: "/common/audit/deleteBatch",
            exportXlsUrl: "common/audit/exportXls",
            importExcelUrl: "common/audit/importExcel",
        },
        options: [],
        filter:true
      }
