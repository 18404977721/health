<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <basic-file-modal ref="modalForm" @ok="modalFormOk"></basic-file-modal>
  </a-card>
</template>
...
<script>
  ...
  import BasicFileModal from './modules/BasicFileModal'
  export default {
    name: "BasicFileList",
    ...
    data () {
      return {
        ...
        url: {
            ...
            deleteBatch: "/common/file/deleteBatch",
            exportXlsUrl: "common/file/exportXls",
            importExcelUrl: "common/file/importExcel",
        },
        options: [],
        filter:true
      }
