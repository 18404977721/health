<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <basic-industry-modal ref="modalForm" @ok="modalFormOk"></basic-industry-modal>
  </a-card>
</template>
...
<script>
  ...
  import BasicIndustryModal from './modules/BasicIndustryModal'
  export default {
    name: "BasicIndustryList",
    ...
    data () {
      return {
        ...
        url: {
            list: "/common/industry/list",
            delete: "/common/industry/delete",
            deleteBatch: "/common/industry/deleteBatch",
            exportXlsUrl: "common/industry/exportXls",
            importExcelUrl: "common/industry/importExcel",
        },
        options: [],
        filter:true
      }
