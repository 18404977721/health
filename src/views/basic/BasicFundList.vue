<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <basic-fund-modal ref="modalForm" @ok="modalFormOk"></basic-fund-modal>
  </a-card>
</template>
...
<script>
  ...
  import BasicFundModal from './modules/BasicFundModal'
  export default {
    name: "BasicFundList",
    ...
    data () {
      return {
        ...
        url: {
            list: "/common/fund/list",
            delete: "/common/fund/delete",
            deleteBatch: "/common/fund/deleteBatch",
            exportXlsUrl: "common/fund/exportXls",
            importExcelUrl: "common/fund/importExcel",
        },
        options: [],
        filter:true
      }
