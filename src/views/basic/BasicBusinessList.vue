<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <basic-business-modal ref="modalForm" @ok="modalFormOk"></basic-business-modal>
  </a-card>
</template>

<script>
  import BasicBusinessModal from './modules/BasicBusinessModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
            list: "/common/business/list",
            delete: "/common/business/delete",
            deleteBatch: "/common/business/deleteBatch",
            exportXlsUrl: "common/business/exportXls",
            importExcelUrl: "common/business/importExcel",
        },
        options: [],
        filter:true
      }
