    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="退回时状态">
          <a-input placeholder="请输入退回时状态" v-decorator="['backStage', {}]" />
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/data/workTaskBack/add",
          edit: "/data/workTaskBack/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'taskId','departId','taskDepartId','departName','backDesc','backStage'))
		  //时间格式化
