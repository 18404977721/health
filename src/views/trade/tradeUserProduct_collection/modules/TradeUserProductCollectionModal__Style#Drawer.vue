...
<script>
  ...
  export default {
    name: "TradeUserProductCollectionModal",
    components: { 
      JDate,
    },
    data () {
      return {
        ...
        url: {
          add: "/trade/tradeUserProductCollection/add",
          edit: "/trade/tradeUserProductCollection/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'userId','projectId','createBy','createTime','updateBy','updateTime'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'userId','projectId','createBy','createTime','updateBy','updateTime'))
      }
