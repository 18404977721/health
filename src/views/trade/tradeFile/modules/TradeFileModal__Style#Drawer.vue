  ...
  <a-drawer
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="文件存储路径" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'filePath', validatorRules.filePath]" placeholder="请输入文件存储路径"></a-input>
        </a-form-item>
        <a-form-item label="文件描述" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'fileDesc', validatorRules.fileDesc]" placeholder="请输入文件描述"></a-input>
        </a-form-item>
